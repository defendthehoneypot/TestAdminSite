...
1. Updatable Object pointing to Vesper DIPL  
...
- **URI**: Your unique DIPL URL from Vesper admin panel
- **Update Interval**: 
...
IPs are automatically updated from DIPL every 15 minutes.
```
...
4. Add an installation comment (e.g., "Added Vesper Secure DIPL integration")  
...
2. Wait for DIPL refresh interval (5-15 minutes depending on your setting)  
...
3. Both SMS instances will independently fetch the DIPL  
...
4. Provides backup access if DIPL is unavailable  
