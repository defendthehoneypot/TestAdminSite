...
3. Your IP is now added to the Dynamic IP List (DIPL)  
...
!!! info "Please Wait Up to 60 Minutes"
    After submitting, your IP is immediately added to the DIPL. However, you need to wait for:
    
    1. **Firewall refresh** - Your firewall polls the DIPL periodically (typically every 5-60 minutes)
